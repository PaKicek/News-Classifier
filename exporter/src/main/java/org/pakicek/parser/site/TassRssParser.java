...
/**
 * Parser for TASS RSS feed
 */
public class TassRssParser extends BaseRssParser {
    private static final String RSS_URL = "https://tass.ru/rss/v2.xml";
    private static final String WEBSITE_NAME = "TASS";

    public TassRssParser() {
    ...
    protected NewsItem parseNewsItem(Element itemElement) {
        ...
        try {
            ...
            if (author.isEmpty()) {
                ...
                if (author.isEmpty()) {
                    author = getElementTextWithNamespace(itemElement, "dc:publisher");
                }
            }
            ...
            if (category.isEmpty()) {
                category = getElementTextWithNamespace(itemElement, "dc:subject");
            }
