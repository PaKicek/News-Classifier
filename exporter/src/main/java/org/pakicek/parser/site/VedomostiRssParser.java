...
/**
 * Parser for Vedomosti RSS feeds (multiple categories)
 */
public class VedomostiRssParser extends MultiFeedRssParser {

    public VedomostiRssParser() {
        super("Vedomosti.ru");
    }
    ...
    protected NewsItem parseNewsItem(Element itemElement) {
        ...
        try {
            ...
            System.err.println("Error parsing Vedomosti item: " + e.getMessage());
            return null;
        }
    }
